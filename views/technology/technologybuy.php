        ...
        <div class="page__row page__middle clearfix">
            <main class="content page__region">
                <section class="content__block">
                    ...
                    <?if(!empty($_SESSION['user_id'])):?>
                        <div class="add_obj">
                            <a href="#" id="add_technology_buy" class="add_obj-item">
...
<?php if($_SESSION['user_id']):?>
    ...
    <div class="popup_add_prog" id="modal_technology_buy">
        ...
        <div class="popup_prog_body">
            ...
            <form action="/technologybuy/add/" class="form"  id="market_technology_send"  method="post" enctype="multipart/form-data">
                <label for="company" class="prog_span">Компания: <b><?=Market::getCompanyNameById($_SESSION['user_id'])?></b></label>
                <label class="prog_span">Категория объявления: <b>Технологии - покупка</b></label>
...
<script src="/template/js/add_technology_buy.js"></script>
<script>
