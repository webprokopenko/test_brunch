        ...
        <div class="page__row page__middle clearfix">
            <main class="content page__region">
                <section class="content__block">
                    ...
                    <?if(!empty($_SESSION['user_id'])):?>
                        <div class="add_obj">
                            <a href="#" id="add_partners" class="add_obj-item">
                                Добавить объявление о поиске партнера<br>
                            </a>
                        </div>
                    <?endif;?>
                    <ul class="catalog catalog_style_grid list">
                        <?php foreach($partners_all_list as $technology_list): ?>
                            <li class='list__item catalog-item'>
                                <div class='catalog-item__img-wrapper'>
                                    <img src='/template/img/partners.jpg' class='catalog-item__img' alt='Партнеры'>
                                </div>
                                <div class='catalog-item__body'>
                                    ...
                                    <div class='catalog-item__specs'>
                                        ...
                                        <div class='field'>
                                            ...
                                            <div class='field__value'><?=$technology_list['opisanie_partner']?></div>
                                        </div>
                                    </div>
                                </div>
                            </li>
    ...
    <div class="popup_add_prog" id="modal_technology_sale">
        <div class="popup_prog_header">
            ...
            <div class="prog_header_text">
                Добавить объявление о поиске партнера
            </div>
        </div>
        <div class="popup_prog_body">
            <div class="popup__msg">
            </div>
            <form action="/partners/add/" class="form"  id="market_partners_send"  method="post" enctype="multipart/form-data">
                <label for="company" class="prog_span">Компания: <b><?=Market::getCompanyNameById($_SESSION['user_id']);?></b></label>
                <label class="prog_span">Категория объявления: <b>Технологии - поиск партнера</b></label>
                ...
                <div class="prog_row">
                    <button type="submit" class="btn">Добавить объявление о поиске партнера</button>
                </div>
            </form>
        </div>
    </div>
...
<script src="/template/js/add_partners.js"></script>
<script>
