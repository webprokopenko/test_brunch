var pupups_investors = (function(){
    var setUpListners = function(){
            $('#add_investors').on('click', _openPopup);
            $('#market_investors_send').on('submit', _privateFunc_valid);
        },
    ...
    //Функция добавления объявления о продаже
        _market_equipment_add = function(){
            var form = $("#market_investors_send"),
                url = '/investors/add/',
