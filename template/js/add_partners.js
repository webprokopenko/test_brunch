var pupups_partners = (function(){
    var setUpListners = function(){
            $('#add_partners').on('click', _openPopup);
            $('#market_partners_send').on('submit', _privateFunc_valid);
        },
